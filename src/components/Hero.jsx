            ...
            <div className="flex flex-wrap">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        ...
                        <motion.span
                            ...
                            className="bg-gradient-to-r from-pink-300 Dvia-slate-500 to-purple-500 bg-clip-text text-3xl tracking-tight text-transparent">
                ...
                <div className="w-full lg:w-1/2 lg:p-8">
                    <div className="flex justify-center">
                        ...
                        className="rounded-2xl w-120" src={profilePic} alt="Rushil Sinha" />
                    </div>
                </div>
            </div>
        </div>
